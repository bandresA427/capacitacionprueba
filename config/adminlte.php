...
return [
    ...
    */
    ...
    'auth_logo' => [
        'enabled' => true,
        'img' => [
            'path' => 'vendor/adminlte/dist/img/jeantexlogo.jpg',
            'alt' => 'Auth Logo',
            'class' => '',
            'width' => 50,
            'height' => 50,
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text'    =>  'Manual de Usuarios',
            'icon'    => 'fas fa-solid fa-book',
            'url' => '/Descargar-Manual', // Replace with actual filename
