...
<h1>Agregar practica de comportamiento del personal</h1>
@stop
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('practicas.guardarpractica5')}}" method="post" >
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="observacion" name="observacion" placeholder="Campo Requerido*" >
