...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Formulario de creación de evaluación</h3>
    </div>
    <div class="card-body">
        ...
        <form action="{{ route('evaluaciones.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="titulo" name="titulo" placeholder="Ingrese el título de la evaluación">
            </div>
            ...
            <div class="form-group" id="preguntas">
                @for($i = 1; $i <= 10; $i++) <div class="card" id="pregunta-template">
                    <div class="card-header">
...
<script>
    $(document).ready(function() {
        ...
        // }); 
        // 
        // Si alguna vez necesita nuevamente 15 preguntas habilita esto 
        // tambien cambia la configuracion del ciclo for arriba de 10 a 15 
    });
</script>
@endsection